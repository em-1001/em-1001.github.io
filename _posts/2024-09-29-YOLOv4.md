...
YOLOv3과 YOLOv4 모델을 직접 구현해보고 성능을 실험하는 프로젝트를 진행하면서 알게 된 내용과 실험 결과 등을 정리하고자 한다. 

보안 공부를 접고 나서 AI에 흥미를 갖게 된 후 처음으로 한 AI 프로젝트이다. 이전에 보안 공부를 하면서 적대적 공격(Adversarial Attack)에 대해 알게 된 후로 자연스럽게 Computer Vision 분야에 대해 관심을 갖게 되었고, 그 중에서도 Object detection이라는 분야에 흥미를 느꼈다.

아래는 AI 공부를 처음 시작 했을 때 개념을 정리한 github이다. 컴퓨터 비전 분야로는 stanford의 CS231n 강의가 도움이 된다 하여 해당 강의부터 시작하여  다양한 블로그, Kaggle code, 논문 등을 읽으며 공부하였다. 

[https://github.com/em-1001/AI](https://github.com/em-1001/AI)

어느 정도 공부를 하고 논문도 여럿 읽을 무렵 AI 분야에 연구원이 되고 싶다는 생각이 들었고, 찾아보니 논문을 읽고, 그 안의 내용과 수식을 이해하는 것도 중요하지만, 논문을 코드로 구현할 수 있는 능력도 매우 중요하다는 것을 알게 되었다. 그래서 평소 관심을 갖고 있었던 Object detection 분야에 대한 논문 구현 프로젝트를 해보자는 생각이 들어 하게 된 것이 이 프로젝트이다. 
...
![bbox.png](bbox.png)
                                             ...
                                             (출처 : [https://arxiv.org/pdf/1612.08242.pdf](https://arxiv.org/pdf/1612.08242.pdf))
...
![darknet53.png](darknet53.png)

![model1.png](model1.png)

                                              (출처 : [https://arxiv.org/pdf/1804.02767.pdf](https://arxiv.org/pdf/1804.02767.pdf))
...
![model2.png](model2.png)
                                                 ...
                                                 (출처 : [https://herbwood.tistory.com/21](https://herbwood.tistory.com/21))
...
![CSPDarknet53.png](CSPDarknet53.png)

                                                  (출처 : [https://wikidocs.net/181720](https://wikidocs.net/181720))
...
![diou.png](diou.png)
                                            ...
                                            (출처 : [https://arxiv.org/pdf/1911.08287.pdf](https://arxiv.org/pdf/1911.08287.pdf))
